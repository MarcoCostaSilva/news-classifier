...
def construir_pipeline() -> Pipeline:
    ...
    Os parâmetros de vetorização (max_features=8_000, ngram_range=(1,1), min_df=10,
    dtype=float32) foram ajustados para reduzir o consumo de memória durante o treino,
    dada a restrição de RAM do ambiente de desenvolvimento (8GB, ~2-3GB livres). Essa
    é uma decisão de engenharia consciente diante de hardware limitado, não um ajuste
    arbitrário de qualidade do modelo.
    """
    return Pipeline([
...
def treinar_modelo():
    ...
    print("Treinando pipeline (TF-IDF + Regressão Logística)...")
